...
const MaterialSelf: React.FC = () => {
  ...
  const images = [
    '/gallery/images/material/material1.jpg',
    '/gallery/images/material/material2.jpg',
    '/gallery/images/material/material3.jpg',
    '/gallery/images/material/material5.jpg',
  ];
    ...
    <DimensionPageTemplate
      ...
      contentBody={
        <>
          ...
          <p className="mb-4">
            Reading Dostoevsky's works is a recent addition to my repertoire. During my highschool years, I would
          ...
          <p className="mb-4">
            ...
            My laptop is a recent acquisition because I kept getting distracted when I try to work on my computer, and portability was much more of a need than I first thought.
