...
const SpiritualSelf: React.FC = () => {
  ...
  const images = [
    '/gallery/images/spiritual/spiritual1.jpg',
    '/gallery/images/spiritual/spiritual2.jpg',
    '/gallery/images/spiritual/spiritual3.jpg',
    '/gallery/images/spiritual/spiritual4.jpg',
  ]
